...
1. Run `coco_data_split.py`:
- *Experiment 2*
```
python coco_data_split.py --how stratified --coco_path coco_files\own_experiment_2 --prefix own_experiment_2 --plot_distros --experiment 2
``` 
- *Experiment 3*   
```
python coco_data_split.py --how stratified --coco_path coco_files\own_experiment_3 --prefix own_experiment_3 --plot_distros --experiment 3
``` 

2. Run `export_medians_multi.py`:
- *Experiment 2*
```
python export_medians_multi.py --root_coco_path coco_files\own_experiment_2 --prefix_coco own_experiment_2 --out_path logs/medians/own_experiment_2_medians --output_size 61 61 --bands B02 B03 B04 B08
``` 
- *Experiment 3*
```
python export_medians_multi.py --root_coco_path coco_files\own_experiment_3 --prefix_coco own_experiment_3 --out_path logs/medians/own_experiment_3_medians --output_size 61 61 --bands B02 B03 B04 B08
``` 

3. Run `compute_class_weights.py`:
- *Experiment 2*
```
python compute_class_weights.py --coco_path coco_files\own_experiment_2 --coco_prefix own_experiment_2 --medians_prefix own_experiment_2 --out_prefix own_experiment_2 --fixed_window
``` 
- *Experiment 3*
```
python compute_class_weights.py --coco_path coco_files\own_experiment_3 --coco_prefix own_experiment_3 --medians_prefix own_experiment_3 --out_prefix own_experiment_3 --fixed_window
``` 

4. Run `pad_experiments.py` (Training Modus):
- *Experiment 2*
```
python pad_experiments.py --train --model <convlstm or convstar or unet or tempcnn> --parcel_loss --weighted_loss --root_path_coco coco_files\own_experiment_2 --prefix_coco own_experiment_2 --prefix own_experiment_2 --num_epochs 10 --batch_size 32 --bands B02 B03 B04 B08 --saved_medians --img_size 61 61 --requires_norm --num_workers 16 --num_gpus 1 --fixed_window
``` 
- *Experiment 3*
```
python pad_experiments.py --train --model <convlstm or convstar or unet or tempcnn> --parcel_loss --weighted_loss --root_path_coco coco_files\own_experiment_3 --prefix_coco own_experiment_3 --prefix own_experiment_3 --num_epochs 10 --batch_size 32 --bands B02 B03 B04 B08 --saved_medians --img_size 61 61 --requires_norm --num_workers 16 --num_gpus 1 --fixed_window
``` 

5. Run `pad_experiments.py` (Testing Modus):
- *Experiment 2*
```
python pad_experiments.py --model <convlstm or convstar or unet or tempcnn> --parcel_loss --weighted_loss --root_path_coco coco_files\own_experiment_2 --prefix_coco own_experiment_2 --prefix own_experiment_2 --num_epochs 10 --batch_size 32 --bands B02 B03 B04 B08 --saved_medians --img_size 61 61 --requires_norm --num_workers 16 --num_gpus 1 --fixed_window
``` 
- *Experiment 3*
```
python pad_experiments.py --model <convlstm or convstar or unet or tempcnn> --parcel_loss --weighted_loss --root_path_coco coco_files\own_experiment_3 --prefix_coco own_experiment_3 --prefix own_experiment_3 --num_epochs 10 --batch_size 32 --bands B02 B03 B04 B08 --saved_medians --img_size 61 61 --requires_norm --num_workers 16 --num_gpus 1 --fixed_window
``` 
