...
if __name__ == '__main__':
    ...
    parser.add_argument('--coco_prefix', type=str, default='', required=False,
                        help='Prefix of the COCO file. Default "".')
    parser.add_argument('--medians_prefix', type=str, default='', required=False,
                        help='Prefix of the medians directory. Default "".')
    ...
    if Path(pixel_cnts_name).is_file():
        ...
        for idx in range(len(dm.dataset_train)):
            print(dm.dataset_train.__getitem__(idx))
            try:
